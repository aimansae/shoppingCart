...
const CartSummary = ({
  ...
  return (
    <Card className="bg-white shadow-lg rounded-lg flex-col justify-center text-left p-6 h-auto md:w-max ">
      <CardHeader>
          ...
          <ul className="  divide-y divide-gray-200 ">
            {Object.values(cart).map((item) => {
              ...
              return (
                <li
                  key={item.product.id}
                  className="text-sm md:text-base py-4 flex justify-between gap-2 items-start"
                >
                  <div className="relative flex-shrink-0 bg-yellow-200  ">
                    <Image
                  ...
                  <div className="flex-1">
                    <h4 className="whitespace-nowrap text-sm md:text-base  font-semibold ">
                      {item.product.name}
                    </h4>
